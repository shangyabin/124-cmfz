				...
				<table>
					<tbody>
					  ...
					  <tr>
							...
							<td>
								<input id="password" type="text" name="password" class="text" value="请输入密码" maxlength="20" autocomplete="off"/>
							</td>
					  </tr>
						...
						<tr>
							...
							<td>
								...
								<img id="kaptchaImage" class="captchaImage" src="${pageContext.request.contextPath}/getKaptcha.do?t='+new Date().getTime()" onclick="changeImage()" title="点击更换验证码"/>
							</td>
						</tr>
					<tr>
						<td>
